...
public class Solution {
    ...
    public static class JavaRush {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            for(User a : users) {
                stream.println(a.getFirstName());
                stream.println(a.getLastName());
                stream.println(a.getBirthDate().getTime());
                stream.println(a.isMale());
                stream.println(a.getCountry().getDisplayedName());
            }
        }
